-- Update calculate_visit_invoice_payload to exclude voided payments from all
-- balance and payment-history calculations.
...
BEGIN
  ...
  client_aggs AS (
    SELECT
      ...
      -- Only include non-voided payments
      COALESCE(
  ...
  -- Only non-voided unassigned payments
  SELECT COALESCE(
