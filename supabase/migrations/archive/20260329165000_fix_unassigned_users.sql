-- Adjust the search function to allow claiming floating/unassigned users 
-- and ensure the elevation process locks them into the Admin's organization
...
-- Modify elevate function to officially bind the loose profile to the organization
