-- RPC to safely fetch a Global Passport directly by ID, bypassing isolated RLS
-- Allows restricted viewing access for Admins across the global namespace
...
BEGIN
  ...
  -- Validate caller has global authorization rights (Admin / Staff)
  -- This blocks malicious scripts from regular divers trying to dump the global DB.
