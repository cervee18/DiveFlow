...
export default function OverviewPage() {
  ...
  const [modalSection, setModalSection] = useState<'am' | 'pm' | 'night' | undefined>();
  ...
  // Group trips by UTC date, applying optional category filter
  const visibleTrips = categoryFilter
    ? trips.filter(t => t.trip_type_category === categoryFilter)
    : trips;

  const tripsByDay: Record<string, any[]> = {};
  for (const day of days) {
    tripsByDay[day] = visibleTrips.filter(t => localDateStr(t.start_time) === day);
  }
